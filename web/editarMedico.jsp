<%-- 
    ...
    Created on : 12/07/2016, 02:51:08
    Author     : camila
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="listarMedicos.jsp">Ver médicos</a></li>
            ...
            <div class="jumbotron">
                ...
                <form action="AlterarMedico" method="POST">
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="name" name="crm" value="${param.crm}" class="form-control" id="exampleInputEmail1" placeholder="Digite cidade">
                    </fieldset>
                    <fieldset class="form-group">
                        <label for="exampleInputEmail1">Endereço</label>
                        <input type="name" name="endereco" value="${param.endereco}" class="form-control" id="exampleInputEmail1" placeholder="Digite cidade">
                    </fieldset>
                    <fieldset class="form-group">
                        <label for="exampleInputEmail1">Bairro</label>
                        <input type="name" name="bairro" value="${param.bairro}" class="form-control" id="exampleInputEmail1" placeholder="Digite cidade">
                    </fieldset>
                    <fieldset class="form-group">
                        <label for="exampleInputEmail1">E-mail</label>
                        <input type="email" name="email" value="${param.email}" class="form-control" id="exampleInputEmail1" placeholder="Digite cidade">
                    </fieldset>
                    <fieldset class="form-group">
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="name" name="site" value="${param.site}" class="form-control" id="exampleInputEmail1" placeholder="Digite URL" required="">
                    </fieldset>
                    <fieldset class="form-group">

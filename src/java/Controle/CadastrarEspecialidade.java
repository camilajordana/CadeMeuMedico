 ...
 * @author camila
 */
@WebServlet(name = "CadastrarEspecialidade", urlPatterns = {"/CadastrarEspecialidade"})
public class CadastrarEspecialidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CadastrarEspecialidade</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CadastrarEspecialidade at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
